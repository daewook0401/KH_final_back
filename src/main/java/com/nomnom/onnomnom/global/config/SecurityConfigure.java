    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity.formLogin(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(requests -> {
                    requests.requestMatchers(HttpMethod.POST, "/api/test", "/api/member/mypage-info", "/api/auth/password-confirm","/api/reviews").authenticated();
                    requests.requestMatchers(HttpMethod.DELETE, "/api/auth/logout", "/api/reservation/**","/api/operatings/**","/api/settings/**","/api/reviews").authenticated();
                    //requests.requestMatchers(HttpMethod.DELETE, "/restaurants/**").permitAll();
                    //requests.requestMatchers(HttpMethod.GET).authenticated();
                    requests.requestMatchers(HttpMethod.PUT, "/api/member/social-update", "/api/member/update","/api/reviews").authenticated();
