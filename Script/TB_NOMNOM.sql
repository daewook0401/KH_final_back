...
CREATE TABLE TB_MEMBER (
  ...
  IS_STORE_OWNER CHAR(1) DEFAULT 'N' CHECK (IS_ACTIVE IN ('Y', 'N'))
);
INSERT INTO TB_MEMBER (
  MEMBER_ID, MEMBER_PW, MEMBER_EMAIL, MEMBER_NAME, MEMBER_NICKNAME, MEMBER_ROLE
) VALUES (
  'user01', 'pwHash', 'user01@example.com', '홍길동', 'gildong', 'ROLE_COMMON'
);
